    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="login.php" class="btn btn-primary btn-sm d-flex justify-content-center">add user</a>
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td><a href="editpasien.php?edit=<?= $row['idPasien']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apa anda yakin ingin menghapus data?')">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
                </table>
